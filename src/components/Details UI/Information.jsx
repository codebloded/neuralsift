...
export default function Information() {
    ...
    const fieldsArray = ["Name", "Email", "Phone", "CIN", "PAN", "TAN", "Bank Account Name", "Bank Account Number", "Bank IFSC"]
    return (
        <div style={{
            borderRadius: "15px",
            ...
            <Typography sx={{ color: `${darkMode ? "#ffffff" : "#121212"}`, opacity: "88%" }} variant="h3">Supplier Details</Typography>
